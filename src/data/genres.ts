//This file is static data from the RAWG API for game genres, shgipping the list of genres will help data be available right away, as genres really do not change at over time.
